...
public class BaZiActivity extends d.s {
    ...
    public void lambda$onCreate$0() {
        ...
        sb2.append("来补益。忌");
        ((TextView) findViewById(R.id.tv_element_advice)).setText(sb2.append(strArr3[i13]).append(过旺。).toString());
        ...
        StringBuilder j4 = new StringBuilder(起运年龄：约).append(max).append(岁
