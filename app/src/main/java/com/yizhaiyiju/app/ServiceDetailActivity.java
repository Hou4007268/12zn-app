...
public class ServiceDetailActivity extends d.s {
    ...
    int resolveIconRes(String str) {
        if ("真人1v1咨询".equals(str)) return R.drawable.ic_service_consult;
        if ("请符请物".equals(str)) return R.drawable.ic_service_talisman;
        if ("择日选时".equals(str)) return R.drawable.ic_service_calendar;
        if ("起名改名".equals(str)) return R.drawable.ic_service_name;
        if ("开光法物".equals(str)) return R.drawable.ic_service_talisman;
        if ("户型风水分析".equals(str)) return R.drawable.ic_service_house;
        if ("财运事业咨询".equals(str)) return R.drawable.ic_service_wealth;
        if ("姻缘感情咨询".equals(str)) return R.drawable.ic_service_love;
        if ("装修风水咨询".equals(str)) return R.drawable.ic_service_house;
        if ("流年运势分析".equals(str)) return R.drawable.ic_service_trend;
        if ("风水法事".equals(str)) return R.drawable.ic_service_ritual;
        if ("祖坟阴宅选址".equals(str)) return R.drawable.ic_service_mountain;
        if ("商业风水".equals(str)) return R.drawable.ic_service_business;
    ...
    public void onCreate(Bundle bundle) {
        ...
        ((ImageView) findViewById(R.id.iv_icon)).setImageResource(resolveIconRes(serviceInfo.name));
        ...
        findViewById(R.id.btn_book).setOnClickListener(new View.OnClickListener() {
            ...
            @Override public final void onClick(View view) {
                ...
                switch (i5) { case 0: serviceDetailActivity.lambda$onCreate$1(serviceInfo2, view); break; default: serviceDetailActivity.lambda$onCreate$2(serviceInfo2, view); break; }
            }
        });
        if (serviceInfo.productId != null) {
            ...
            findViewById.setOnClickListener(new View.OnClickListener() {
                ...
                @Override public final void onClick(View view) {
                    ...
                    ServiceInfo serviceInfo2 = serviceInfo;
                    ServiceDetailActivity serviceDetailActivity = this.f2381f;
                    switch (i52) { case 0: serviceDetailActivity.lambda$onCreate$1(serviceInfo2, view); break; default: serviceDetailActivity.lambda$onCreate$2(serviceInfo2, view); break; }
                }
            });
        }
    }
